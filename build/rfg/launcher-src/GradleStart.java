...
public class GradleStart extends GradleStartCommon {
    ...
    protected String getTweakClass() {
        return System.getProperty("gradlestart.clientTweaker", "net.minecraftforge.fml.common.launcher.FMLTweaker");
    }

    @Override
    protected void setDefaultArguments(Map<String, String> argMap) {
        argMap.put("version", "1.12.2");
        argMap.put("assetIndex", "1.12.2");
        argMap.put("assetsDir", "/home/fearxhusky1/.gradle/caches/retro_futura_gradle/assets");
