...
public class GlStateManager
{
    ...
    public static final GlStateManager.AlphaState alphaState = new GlStateManager.AlphaState();
    public static final GlStateManager.BooleanState lightingState = new GlStateManager.BooleanState(2896);
    public static final GlStateManager.BooleanState[] lightState = new GlStateManager.BooleanState[8];
    public static final GlStateManager.ColorMaterialState colorMaterialState;
    public static final GlStateManager.BlendState blendState;
    public static final GlStateManager.DepthState depthState;
    public static final GlStateManager.FogState fogState;
    public static final GlStateManager.CullState cullState;
    public static final GlStateManager.PolygonOffsetState polygonOffsetState;
    public static final GlStateManager.ColorLogicState colorLogicState;
    public static final GlStateManager.TexGenState texGenState;
    public static final GlStateManager.ClearState clearState;
    public static final GlStateManager.StencilState stencilState;
    public static final GlStateManager.BooleanState normalizeState;
    ...
    public static final GlStateManager.BooleanState rescaleNormalState;
    public static final GlStateManager.ColorMask colorMaskState;
    public static final GlStateManager.Color colorState;
